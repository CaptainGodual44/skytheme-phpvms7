<div class="sidebar sidebar-dark sidebar-fixed border-end" id="sidebar">
  <div class="sidebar-header border-bottom" style="justify-content: center">
  ...
  <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
    ...
    <li class="nav-title">Flight Operations</li>
    <li class="nav-item"><a class="nav-link" href="{{ route('frontend.flights.index') }}">
        <svg class="nav-icon">
          <use xlink:href="/assets/coreui/vendors/@coreui/icons/svg/free.svg#cil-drop"></use>
        </svg> {{ trans_choice('common.flight', 2) }}</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ route('frontend.flights.bids') }}">
        <svg class="nav-icon">
          <use xlink:href="/assets/coreui/vendors/@coreui/icons/svg/free.svg#cil-pencil"></use>
        </svg> {{ trans_choice('flights.mybid', 2) }}</a></li>
