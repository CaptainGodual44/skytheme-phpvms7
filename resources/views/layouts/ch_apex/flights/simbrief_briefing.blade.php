              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <input id="download_fms"
                         type="submit"
                         class="btn btn-outline-primary pull-end mt-3"
                         value="Download"/>
                </div>
              </div>
            </div>
            ...
            <div class="form-container-body">
              <div class="row">
                <div class="col-3" align="center">
                  <a href="{{ $simbrief->xml->prefile->ivao->link }}" target="_blank" class="btn btn-info">IVAO</a>
                </div>
                <div class="col-3" align="center">
                  <a href="{{ $simbrief->xml->prefile->vatsim->link }}" target="_blank" class="btn btn-info">VATSIM</a>
                </div>
                <div class="col-3" align="center">
                  <a href="{{ $simbrief->xml->prefile->poscon->link }}" target="_blank" class="btn btn-info">POSCON</a>
                </div>
                <div class="col-3" align="center">
                  <a
                    ...
                    target="_blank" class="btn btn-info">View @ SkyVector</a>
                </div>
              </div>
            </div>
          </div>
