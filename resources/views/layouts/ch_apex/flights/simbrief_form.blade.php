                    ...
                    <tr>
                        ...
                        <td>
                          <select name="planformat" class="form-control">
                            <option @if(strtolower($flight->airline->icao) == "lido") selected @endif value="lido">LIDO</option>
                            <option @if(strtolower($flight->airline->icao) == "aal") selected @endif value="aal" >American Airlines</option>
                            <option @if(strtolower($flight->airline->icao) == "aca") selected @endif value="aca" >Air Canada</option>
                            <option @if(strtolower($flight->airline->icao) == "afr") selected @endif value="afr" >Air France (2012)</option>
                            <option @if(strtolower($flight->airline->icao) == "") selected @endif value="afr2017" >Air France (2017)</option>
                            <option @if(strtolower($flight->airline->icao) == "awe") selected @endif value="awe" >US Airways</option>
                            <option @if(strtolower($flight->airline->icao) == "baw") selected @endif value="baw" >British Airways</option>
                            <option @if(strtolower($flight->airline->icao) == "ber") selected @endif value="ber" >Air Berlin</option>
                            <option @if(strtolower($flight->airline->icao) == "dal") selected @endif value="dal" >Delta Air Lines</option>
                            <option @if(strtolower($flight->airline->icao) == "dlh") selected @endif value="dlh" >Lufthansa</option>
                            <option @if(strtolower($flight->airline->icao) == "ein") selected @endif value="ein" >Aer Lingus</option>
                            <option @if(strtolower($flight->airline->icao) == "etd") selected @endif value="etd" >Etihad Airways</option>
                            <option @if(strtolower($flight->airline->icao) == "ezy") selected @endif value="ezy" >easyJet</option>
                            <option @if(strtolower($flight->airline->icao) == "gwi") selected @endif value="gwi" >Germanwings</option>
                            <option @if(strtolower($flight->airline->icao) == "jbu") selected @endif value="jbu" >JetBlue Airways</option>
                            <option @if(strtolower($flight->airline->icao) == "jza") selected @endif value="jza" >Jazz Aviation</option>
                            <option @if(strtolower($flight->airline->icao) == "klm") selected @endif value="klm" >KLM Royal Dutch Airlines</option>
                            <option @if(strtolower($flight->airline->icao) == "qfa") selected @endif value="qfa" >Qantas</option>
                            <option @if(strtolower($flight->airline->icao) == "ryr") selected @endif value="ryr" >Ryanair</option>
                            <option @if(strtolower($flight->airline->icao) == "swa") selected @endif value="swa" >Southwest Airlines</option>
                            <option @if(strtolower($flight->airline->icao) == "thy") selected @endif value="thy" >Turkish Airlines</option>
                            <option @if(strtolower($flight->airline->icao) == "uae") selected @endif value="uae" >Emirates Airline</option>
                            <option @if(strtolower($flight->airline->icao) == "ual") selected @endif value="ual" >United Airlines (2012)</option>
                            <option @if(strtolower($flight->airline->icao) == "") selected @endif value="ual f:wz" >United Airlines (2018)</option>
                          </select>
                        </td>
                      </tr>
                    <tr>
