  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-12">
        ...
        <p>
          @if($tour->completed)
            <span class="badge text-bg-success">Completed</span> You have already completed this charter/tour and aquired an award. But you can of course fly again.
          @elseif($tour->in_progress)
            <span class="badge text-bg-warning">In Progress</span> You have completed one or more legs of this charter/tour already. Keep going to receive your award!
          @else
            <span class="badge text-bg-info">Available</span> After completion of the charter/tour you will automatically receive an award.
          @endif
        </p>
        <h2>Tour legs</h2>
