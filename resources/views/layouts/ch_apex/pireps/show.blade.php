    ...
    <div class="col-4">
      <table class="table table-striped">
        <tr>
          ...
          <td>
            @php
              // PirepState Badge CSS Classes
              $pirep_state_css = "bg-info";
              switch($pirep->state) {
                  case \App\Models\Enums\PirepState::ACCEPTED:
                      $pirep_state_css = "bg-success";
                      break;
                  case \App\Models\Enums\PirepState::CANCELLED:
                  case \App\Models\Enums\PirepState::PENDING:
                      $pirep_state_css = "bg-warning";
                  case \App\Models\Enums\PirepState::REJECTED:
                      $pirep_state_css = "bg-danger";
              }
            @endphp
            <div class="badge {{$pirep_state_css}}">
        ...
        <tr>
          ...
          <td>
            @php
              // PirepStatus Badge CSS Classes
              $pirep_status_css = "bg-info";
              switch($pirep->status) {
                  case \App\Models\Enums\PirepStatus::ARRIVED:
                      $pirep_status_css = "bg-success";
                      break;
                  case \App\Models\Enums\PirepStatus::BOARDING:
                      $pirep_status_css = "bg-primary";
                  case \App\Models\Enums\PirepStatus::DIVERTED:
                      $pirep_status_css = "bg-warning";
              }
            @endphp
            <div class="badge {{$pirep_status_css}}">
